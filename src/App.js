...
import yamiliBraider from './components/assets/images/me-with-client.jpeg'
    ...
    <div className="App">
      <nav className='navbar'>
        ...
        <div className='container-inside-navbar'>
          ...
          <div className='second-menu'>
            ...
            <li><a href="#grid-container" className="nav-button">Contacto</a></li>
            </ul>
          </div>
      ...
      <section className='main-container'>
        ...
        <div className='main-container-text'>
            ...
            <p>Dreadlocks / Rastas con extensión</p>
                <a href="https://wa.me/+525578029544" class="button2" target="_blank">
                  WhatsApp
      ...
      <section className='grid-container'>
        <div class="parent">
          ...
          <div class="div3" id="grid-container">
            <h1>Servicio de Braids para niños</h1>
          </div>
        </div>
      </section>
